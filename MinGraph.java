...
public class MinGraph
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("Run number:" + "," + "Average Run time:" + "," + "Color Accuracy:");

        final float NUMBER_OF_TRIAL_RUNS = 10;

        int timesToRun = inputGraph.edgeCount / vertexCount;
        ...
        for (int trialNumber = 1; trialNumber <= NUMBER_OF_TRIAL_RUNS; trialNumber++)
        {
            ...
            //Valid for flat 1000
            if (countDistinct(optimumVertexColors, optimumVertexColors.length) < 40)
            {
                correctCounter++;
            }
        ...
        System.out.println((timesToRun) + "," + (totalRuntime / NUMBER_OF_TRIAL_RUNS) + "," + (correctCounter / NUMBER_OF_TRIAL_RUNS) * 100 + "%");
    }
}
